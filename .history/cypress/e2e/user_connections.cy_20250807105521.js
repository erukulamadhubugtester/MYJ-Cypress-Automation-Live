  ...
  it("Connections  ", () => {
    ...
    cy.get(".flex-wrap > :nth-child(1) > .cursor-pointer")
      ...
      .then((sentText) => {
        ...
        expect(sentCount).to.match(/Sent\s+\d+/); // ✅ Example: "Sent 3"
      });
    ...
    cy.get(".flex-wrap > :nth-child(2) > .cursor-pointer")
      ...
      .then((receivedText) => {
        ...
        expect(receivedCount).to.match(/Received\s+\d+/); // ✅ Example: "Received 5"
      });
    ...
    cy.get(".flex-wrap > :nth-child(3) > .cursor-pointer")
      ...
      .then((connectedText) => {
        ...
        expect(connectedCount).to.match(/Connected\s+\d+/); // ✅ Example: "Connected 2"
      });
