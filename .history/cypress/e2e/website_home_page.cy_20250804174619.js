import './commands'; // ✅ Must import the file where you define custom commands
...
describe("MakeYourJodi UI Smoke Test", () => {
  it("verifies key elements are present", () => {
    ...
    cy.get(".gap-2 > .w-auto").scrollBelowHeader();
    cy.get(".container > .p-2").scrollBelowHeader();
    cy.get(".text-xl").scrollBelowHeader();
    cy.get("#age > .select__control").scrollBelowHeader();
    cy.get("#education > .select__control").scrollBelowHeader();
    cy.get(":nth-child(3) > .border").scrollBelowHeader();
    cy.get("a.w-full > .w-full").scrollBelowHeader();
    cy.get(".sm\\:mt-20").scrollBelowHeader();
    cy.get(".text-black").scrollBelowHeader();
    cy.get(".flex.mt-6 > .w-full").scrollBelowHeader();
    ...
    cy.get(":nth-child(5) > .w-full").scrollBelowHeader();
    ...
    cy.get(".md\\:p-8 > .text-center").scrollBelowHeader();
    cy.get(".mt-5 > a > img").scrollBelowHeader();
    cy.get(".w-\\[200px\\]").scrollBelowHeader();
    cy.get(".min-w-\\[280px\\] > .mt-5").scrollBelowHeader();
    cy.get(
    ...
    cy.get(".h-\\[50px\\]").scrollBelowHeader();
    ...
    cy.get(".flex-2 > .font-semibold").scrollBelowHeader();
    ...
    cy.get(".mt-6 > span").scrollBelowHeader();
  });
});
