describe("MakeYourJodi UI Smoke Test", () => {
  it("verifies key elements are present", () => {
    ...
    cy.get(".gap-2 > .w-auto").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
    cy.get(".container > .p-2").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
    ...
    cy.get("#age > .select__control").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
    cy.get("#education > .select__control").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
    cy.get(":nth-child(3) > .border").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
    cy.get("a.w-full > .w-full").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
    cy.get(".sm\\:mt-20").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
    cy.get(".text-black").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
    cy.get(".flex.mt-6 > .w-full").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
    ...
    cy.get(":nth-child(5) > .w-full").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
    ...
    cy.get(".md\\:p-8 > .text-center").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
    cy.get(".mt-5 > a > img").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
    cy.get(".w-\\[200px\\]").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
    cy.get(".min-w-\\[280px\\] > .mt-5").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
    ...
    cy.get(".mt-6 > span").scrollIntoView({
      block: "center",
      inline: "center",
      behavior: "smooth",
    });
