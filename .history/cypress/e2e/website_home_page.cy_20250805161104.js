describe("MakeYourJodi UI Smoke Test", () => {
  ...
  it("verifies and highlights all key UI elements", () => {
    ...
    highlight(".flex.mt-6 > .flex > .text-\\[\\#AB1D79\\]", "Why MYJ - Title 1");
    highlight(".flex.mt-6 > .flex > .text-\\[\\#666\\]", "Why MYJ - Desc 1");
    highlight(".md\\:justify-between > :nth-child(4) > .w-full", "Why MYJ - Card 2");
    highlight(":nth-child(4) > .flex > .text-\\[\\#AB1D79\\]", "Why MYJ - Title 2");
    highlight(":nth-child(4) > .flex > .text-\\[\\#666\\]", "Why MYJ - Desc 2");
    highlight(":nth-child(5) > .w-full", "Why MYJ - Card 3");
    highlight(":nth-child(5) > .flex > .text-\\[\\#AB1D79\\]", "Why MYJ - Title 3");
    ...
    highlight('[href="https://www.linkedin.com/showcase/make-your-jodi/about/?viewAsMember=true"] > .h-\\[30px\\]', "LinkedIn Icon");
    highlight('[href="https://www.facebook.com/people/Make-Your-Jodi/61577330596796/?sk=about"] > .h-\\[30px\\]', "Facebook Icon");
    highlight('[href="https://www.instagram.com/makeyourjodi.com_?igsh=MXVja2JkaWF2YXhobw=="] > .h-\\[30px\\]', "Instagram Icon");
    highlight('[href="https://x.com/MakeYourJodi"] > .h-\\[30px\\]', "Twitter Icon");

    highlight(".h-\\[50px\\]", "Copyright");

    cy.log("🔍 Checking Platform Highlights Section");
    highlight(".flex-\\[2\\] > .font-semibold", "Platform Header");
    highlight(".flex > .mt-5 > :nth-child(1) > .transition-all", "Platform Card 1");
    highlight(".mt-5 > :nth-child(2) > .transition-all", "Platform Card 2");
    highlight(".sm\\:mt-5 > :nth-child(1) > .transition-all", "Platform Card 3");
    highlight(".sm\\:mt-5 > :nth-child(2) > .transition-all", "Platform Card 4");
