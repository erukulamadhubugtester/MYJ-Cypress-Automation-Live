...
//     cy.get(".form-control").type("916303481147"); // Step 1: Enter phone number
...
//         // ✅ Popup is displayed
//         cy.log("✅ Profile Completion Popup is displayed");

//         // 1. Check % of profile text
//         cy.get(".mt-6 > .text-2xl")
//           .should("be.visible")
//           .then(($el) => {
...
//         // 7. Click cancel icon to close popup (with force to ensure it works)
//         cy.get(".top-4").should("be.visible").click({ force: true });

//         cy.log("🗙 Popup closed by clicking cancel icon.");
//       } else {
//         // ❌ Popup not displayed - log and continue
//         cy.log("ℹ️ Profile completion popup not displayed.");
//       }
//     });
//   });
// });
...
describe("Login and Popup Handling", () => {
  ...
  it("should land on homepage after login", () => {
    cy.url().should("https://makeyourjodi.com/home");
  });
});
